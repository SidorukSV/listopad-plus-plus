...
Текущая версия: **0.1.2**. История изменений приведена в
...
- read-only hex/ASCII-просмотр бинарных файлов с memory mapping, байтовым
  поиском и ручным переключением текстового представления;
...
В текущую реализацию не входят поиск по каталогам, diff/merge, плагины, LSP,
автодополнение, восстановление после сбоя, восстановление сессии и
автообновление.
...
`indentWithTabs`, `documentMap` и `largeFileThreshold` в байтах.
