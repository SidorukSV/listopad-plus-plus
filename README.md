...
плагины, LSP, автодополнение, восстановление после сбоя, восстановление сессии
и автообновление.
...
сертификата. Неподписанная сборка запускается как обычно, но UAC-сохранение
отключается. Для локальной разработки можно явно создать тестовый сертификат:
